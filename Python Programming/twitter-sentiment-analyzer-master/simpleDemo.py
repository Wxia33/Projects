...
inpTweets = csv.reader(open('data/training_neatfile.csv', 'rb'), delimiter=',', quotechar='"')
#inpTweets = csv.reader(open('data/sampleTweets.csv', 'rb'), delimiter=',', quotechar='|')
#inpTweets = open('data/baseline_output.txt','r')
...
while True:
    Tweet = raw_input('Sentiment Analyzed: ')
    processedTweet = processTweet(Tweet)
